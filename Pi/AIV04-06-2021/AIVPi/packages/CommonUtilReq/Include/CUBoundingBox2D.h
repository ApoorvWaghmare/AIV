...
public :
	...
	//Gets minimun distance between bounding boxes
	//returns -1 if one box partially/completely lies inside the other
	double GetMinDistanceBetweenBoxes(const BoundingBox2D &box)const;
};
